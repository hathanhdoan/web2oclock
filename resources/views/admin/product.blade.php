                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div>
                                    ...
                                    <select id="Categories" name="Categories" style="background-color: white"></select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div>
                                    <label for="District">Quận</label>
                                    <select id="District" name="District" style="background-color: white">
                            ...
                            <div class="col-md-6">
                                <div>
                                    ...
                                    <select id="City" name="City" style="background-color: white">
                            ...
                            <div class="col-md-3">
                                <div>
                                    ...
                                    <select id="OpenHour" name="OpenHour" style="background-color: white">
                            ...
                            <div class="col-md-3">
                                <div>
                                    ...
                                    <select id="OpenMinute" name="OpenMinute" style="background-color: white">
                                        <option value="00">00</option>
                                        <option value="01">01</option>
                                        <option value="02">02</option>
                                        <option value="03">03</option>
                            ...
                            <div class="col-md-3">
                                <div>
                                    ...
                                    <select id="CloseHour" name="CloseHour" style="background-color: white">
                                        <option value="00">00</option>
                                        <option value="01">01</option>
                                        <option value="02">02</option>
                                        <option value="03">03</option>
                            ...
                            <div class="col-md-3">
                                <div>
                                    ...
                                    <select id="CloseMinute" name="CloseMinute" style="background-color: white">
                                        <option value="00">00</option>
                                        <option value="01">01</option>
                                        <option value="02">02</option>
                                        <option value="03">03</option>
